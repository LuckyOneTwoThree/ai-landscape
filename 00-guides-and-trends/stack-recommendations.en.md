...
| Model | **GPT-5.5-mini / Claude Haiku 4** | [DeepSeek-V4-Flash](https://deepseek.com) |
...
| Audio Generation | **ElevenLabs / Suno** | [Bark](https://github.com/suno-ai/bark) |
...
| Deep Learning | **PyTorch / TensorFlow** | [JAX](https://github.com/google/jax) |
| LLM Analysis | **GPT-5.5 / Claude Opus 4.8** | [Gemini 3.1 Pro](https://gemini.google.com) |
