...
> 2026 年 AI Agent 技能不再只是简单的工具调用，而是深入设计、编码、研究、营销等专业领域。MCP 等工具协议已移至 [06-工具与协议](../06-tools-and-protocols/mcp.md) 统一管理。
...
| [impeccable](https://github.com/pbakaus/impeccable) | 设计语言，让你的 AI Agent 更擅长设计 | open-source, content-creation, coding | 36.3K Stars<br>设计语言<br>AI 设计优化 |
| [Huashu Design](https://github.com/alchaincyf/huashu-design) | HTML 原生设计技能，Claude Code 专用 | content-creation, data-analysis, coding-assistant | 17.5K Stars<br>HTML 原生设计<br>Claude Code 专用 |
| [frontend-design](https://github.com/nicekid1/frontend-design) | 让 Claude 具备设计规范意识，内置设计系统知识，支持 Tailwind/shadcn | content-creation, coding | 设计规范意识<br>Tailwind/shadcn<br>响应式布局 |
| [Hallmark](https://github.com/Nutlope/hallmark) | 反 AI 设计技能，让 AI 生成更有品味的 UI | content-creation, security | 3K Stars<br>反 AI 设计<br>更有品味的 UI |
| [design-md-chrome](https://github.com/bergside/design-md-chrome) | Chrome 扩展，从任何网站提取样式并生成设计规范 | content-creation, vscode-extension, data-analysis | 2.2K Stars<br>Chrome 扩展<br>样式提取 |
| [awesome-design-skills](https://github.com/bergside/awesome-design-skills) | 67 个设计技能文件精选列表 | content-creation, open-source, mcp | 1.2K Stars<br>67 个设计技能<br>精选列表 |
| [UI Design Brain](https://github.com/carmahhawwari/ui-design-brain) | 给 AI Agent UI 组件知识 | content-creation | 816 Stars<br>UI 组件<br>AI Agent |
...
| [infiAgent](https://github.com/polyuiislab/infiAgent) | 构建 Cowork/AI Scientist 等 Agent | coding, agent, mcp | 1.2K Stars<br>构建 Agent<br>Cowork/AI Scientist |
...
| [AI Research Skills](https://github.com/Orchestra-Research/AI-Research-SKILLs) | AI 研究与工程技能库，综合全面 | deep-research, agent, automation | 9.4K Stars<br>AI 研究<br>工程技能 |
| [Trail of Bits Skills](https://github.com/trailofbits/skills) | Trail of Bits 安全研究技能，漏洞检测 | security, deep-research | 5.6K Stars<br>安全研究<br>漏洞检测 |
| [Auto Empirical Research Skills](https://github.com/brycewang-stanford/Auto-Empirical-Research-Skills) | 23000+ Agent 技能，用于实证研究 | deep-research, academic, mcp | 1.8K Stars<br>23000+ 技能<br>实证研究 |
| [medical-research-skills](https://github.com/aipoch/medical-research-skills) | 医学研究技能，临床/药物/文献 | deep-research, academic | 1K Stars<br>医学研究<br>临床/药物 |
...
| [claude-blog](https://github.com/AgriciDaniel/claude-blog) | Claude Code 博客技能套件，30 个子技能 | content-creation, coding-assistant | 1K Stars<br>博客技能<br>30 个子技能 |
| [ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills) | 简历优化技能 | content-creation, automation | 717 Stars<br>简历优化<br>求职技能 |
| [sciwrite](https://github.com/labarba/sciwrite) | AI 辅助手稿写作审查 | content-creation, academic, coding-assistant | 693 Stars<br>手稿审查<br>科学写作 |
...
| [Claude Skills (alirezarezvani)](https://github.com/alirezarezvani/claude-skills) | 337 个 Claude Code 技能，30+ Agent | all-in-one, mcp, agent | 17.5K Stars<br>337 个技能<br>30+ Agent |
...
## ⚡ 实战指南：如何把神级 Skill 塞进你的 Agent？

新手面对上面成百上千的技能库往往无从下手。其实在 2026 年，所谓的“Skill（技能）”通常只有两种最简形态，扒下来极其容易：

### 形态 1：纯 Prompt / Markdown 形态 (如 `taste-skill` / `CLAUDE.md`)
这类技能本质上是写得极其精妙的**系统指令**。
- **怎么用**：直接进入该项目的 GitHub 仓库，找到 `.md` 或 `.txt` 文件，把它复制并粘贴到你的 Cline 的 `Custom Instructions` 里，或者放到你项目根目录的 `CLAUDE.md` 中。你的 AI 瞬间就具备了“顶级设计师的审美”或“高级架构师的代码规范”。

### 形态 2：MCP Server 形态 (如各种自动化发推、搜索技能)
这类技能通常是一个包含具体执行代码的项目包。
- **怎么用**：在你的 IDE（如 Cursor）的 MCP 配置面板中，将该技能仓库以 `npx` 或本地 Python 脚本的形式挂载进去。AI 在需要时会自动通过协议调用这些“外挂动作”。
