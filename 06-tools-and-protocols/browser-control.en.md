...
| **Command Line Automation Scripts** | [**Agent Browser**](https://github.com/vercel-labs/agent-browser) | By [Vercel](https://vercel.com), CLI format, lightweight and easy to integrate |
...
| **System-Level Screen Control** | [**Anthropic / OpenAI Computer Use**](https://openai.com) | Not limited to browsers, can control any desktop application |
