...
| 工具 | 核心优势 | 适合谁 |
| ------ | --------- | -------- |
| [**OpenAI Moderation**](https://platform.openai.com/docs/guides/moderation) | 内置，免费 | OpenAI 用户 |

### 🟢 开源模型型

| 工具 | Stars | 核心优势 | 适合谁 |
| ------ | ------- | --------- | -------- |
| [**Llama Guard**](https://github.com/meta-llama/PurpleLlama) | 3K | Meta 出品，内容安全分类 | 内容审核 |
...
| 维度 | 说明 | 工具支持 |
| ------ | ------ | --------- |
| **暴力** | 暴力内容检测 | OpenAI, [Llama Guard](https://github.com/meta-llama/PurpleLlama) |
| **色情** | 色情内容检测 | OpenAI, [Llama Guard](https://github.com/meta-llama/PurpleLlama) |
| **仇恨** | 仇恨言论检测 | OpenAI, [Llama Guard](https://github.com/meta-llama/PurpleLlama) |
| **自残** | 自残内容检测 | OpenAI |
