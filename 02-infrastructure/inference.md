...
| ✅ [xinference](https://github.com/xorbitsai/inference) | Python | 取决于后端 | 405B | Docker, pip | 多后端 ([vLLM](https://github.com/vllm-project/vllm)/[llama.cpp](https://github.com/ggerganov/llama.cpp)/TensorRT)<br>模型管理/分布式推理<br>OpenAI 兼容 API |
